...
public class NodeModelFactory
{
	...
	public static NodeModel createResourceModel( 
		Project project )
	{
	...
	public static NodeModel createTaskModel( 
		Project project )
	{
...
//	public NodeModel createAssignmentNodeModel(
...
//	}
	...
	{
		return new AssignmentNodeModel( /*(ArrayList)model.getList().clone(),*/
			(MutableNodeHierarchy)model.getHierarchy().clone(), model.getDataFactory(), document, containsLeftObjects );
	}
	...
	public void updateNodeModelFromCollection( 
		NodeModel nodeModel,
		...
		Transformer transformer )
	{
		...
		if (children != null)
		{
			...
			while (i.hasNext())
			{
				...
				Object newImpl = transformer.transform( sourceNode.getValue() ); // make a new object from source
