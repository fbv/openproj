...
public class NodeFactory
{
	...
	public Node<?> createGroup( 
		final NodeGroup _group,
		final String _name )
	{
		try
		{
			final GroupNodeImpl groupImpl = new GroupNodeImpl();
			groupImpl.setName( (_name == null)
				? _group.getSorterId()
				: _name );

			//groupImpl.setGroupFields(group.getSorter().getFields());
			return new NodeBridge<GroupNodeImpl>( groupImpl );
		}
		catch (Exception e)
		{
			return null;
		...
		final Object _value )
	{
		try
		{
			return new NodeBridge<Object>( _value );
		}
		catch (Exception e)
		{
			return null;
	...
	public Node<Resource> createNode( 
		final Resource _value )
	{
		try
		{
			return new NodeBridge<Resource>( _value );
		}
		catch (Exception e)
		{
			return null;
	...
	public Node<Resource> createResource( 
	...
	public Node createTask( 
		final Project _project )
	{
		return new NodeBridge( Model.getInstance().createTask( _project ) );
	}
	...
	public Node createTestNode()
	{
		try
		{
			...
			org.openproj.domain.task.Task task = project.newTaskInstance();
