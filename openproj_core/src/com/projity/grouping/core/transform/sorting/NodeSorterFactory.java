	...
	public CommonTransform getTransform() throws InvalidFormulaException{
		...
		if (formulaText!=null){
		    ...
		    classText.append("\tpublic int compare(Object _nodeObject1,Object _nodeObject2){\n\t\tObject ")
		    	.append(type1).append("=(_nodeObject1 instanceof Node)?((Node)_nodeObject1).getValue():_nodeObject1;\n\t\tObject ")
		    	.append(type2).append("=(_nodeObject2 instanceof Node)?((Node)_nodeObject2).getValue():_nodeObject2;\n")
