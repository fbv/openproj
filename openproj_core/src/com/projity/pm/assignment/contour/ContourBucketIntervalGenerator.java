...
{
	protected ContourBucketIntervalGenerator( 
		...
		Object type )
	{
		...
		if ((assignment.getDependencyStart() > assignmentStart) && (assignment.getPercentComplete() > 0.0D))
		{ // if a split caused by remaining work being pushed out by a dependency
			durationLeftUntilRemainingStartDependency = workCalendar.compare( assignment.getDependencyStart(), assignmentStart,
					false );
...
//	}
	 ...
	 * @return 
	 */
	public AbstractContourBucket getBucket()
	{
	...
	public static ContourBucketIntervalGenerator getInstance( 
		Assignment assignment,
		Object type )
	{
	...
	{
		AbstractContourBucket cur = getBucket();
