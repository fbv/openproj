 ...
 */
public class ClosureCollectionSum
		...
		DoubleValue
{
	...
	{
		myValue = myChildList.getValue();
		myTotal += myValue;
	}

	public static ClosureCollectionSum getInstance( 
		final AssignmentFieldClosureCollection _childList )
	{
		return new ClosureCollectionSum( _childList );
	}
	...
	private AssignmentFieldClosureCollection myChildList;
