 ...
 */
public class PersonalContourMaker
	extends AssignmentFieldFunctor
{
	private PersonalContourMaker( 
		...
		final HasStartAndEnd _interval )
	{
		...
		{
			list.add( PersonalContourBucket.getInstance( bucket.getBucketDuration( assignmentDuration ),
					bucket.getUnits() * multiplier ) );
		}
	}

	public static PersonalContourMaker getInstance( 
		Assignment assignment,
		ContourBucketIntervalGenerator contourBucketIntervalGenerator )
	{
