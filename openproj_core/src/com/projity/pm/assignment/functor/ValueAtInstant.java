	...
	extends AssignmentFieldFunctor
{
	...
	{
		if ((_interval.getStart() == triggerDate) && (_interval.getEnd() == triggerDate))
		{
			myValue = constant;
	...
	public static ValueAtInstant getInstance( 
		long triggerDate,
		double constant )
	{
