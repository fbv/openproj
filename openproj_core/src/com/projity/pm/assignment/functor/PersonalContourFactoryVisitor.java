 ...
 */
public class PersonalContourFactoryVisitor
	implements CalculationVisitor<Query>
{
	/**
	 *
	 */
	private PersonalContourFactoryVisitor( 
		...
		Query arg0 )
	{
		...
		costContour[ index++ ] = PersonalContourBucket.getInstance( fromBucket.getBucketDuration( assignmentDuration ),
				cost.getValue() );
	}

	public static PersonalContourFactoryVisitor getInstance( 
		AbstractContourBucket[] costContour,
		CostFunctor cost,
		long assignmentDuration )
	{
