...
{
	private ResourceAvailabilityFunctor( 
		Assignment assignment )
	{
		...
		if (myWorkCalendar == null)
		{
			...
			myWorkCalendar = assignment.getTask().getProject().getEffectiveWorkCalendar();
		}
	...
	{
		myValue += (maxUnits * myWorkCalendar.compare( _interval.getEnd(), _interval.getStart(), false ));
	}

	public static ResourceAvailabilityFunctor getInstance( 
		Assignment assignment )
	{
