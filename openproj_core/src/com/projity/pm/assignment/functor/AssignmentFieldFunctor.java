		...
		DoubleValue
{
	 ...
	 * @param _assignment
	 * @param _workCalendar
	 * @param _contourBucketIntervalGenerator 
	 */
	AssignmentFieldFunctor( 
		final Assignment _assignment,
		final WorkCalendar _workCalendar,
		final ContourBucketIntervalGenerator _contourBucketIntervalGenerator )
	{
		myAssignment = _assignment;
		myWorkCalendar = _workCalendar;
		myContourBucketIntervalGenerator = _contourBucketIntervalGenerator;
	}
...
//	}
	...
	{
		return myContourBucketIntervalGenerator;
	}
	...
	protected Assignment myAssignment;
	protected ContourBucketIntervalGenerator myContourBucketIntervalGenerator;
	protected WorkCalendar myWorkCalendar = null;
	protected boolean myCumulative = false;
	private double myMultiplier = 1.0D;
