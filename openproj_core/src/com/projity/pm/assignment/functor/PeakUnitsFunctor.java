 ...
 *
 */
public class PeakUnitsFunctor
	extends AssignmentFieldFunctor
{
	private PeakUnitsFunctor( 
	...
	{
		final AbstractContourBucket bucket = myContourBucketIntervalGenerator.getBucket();

		if (bucket != null)
		{
			myValue = Math.max( myValue, bucket.getEffectiveUnits( myAssignment.getUnits() ) );
		}
	}

	public static PeakUnitsFunctor getInstance( 
