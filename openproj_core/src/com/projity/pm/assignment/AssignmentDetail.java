...
//	private boolean timesheetClosed = false;
	...
	public void setPercentComplete(double percentComplete) {
		...
		{
			((Task)getTask()).adjustActualStartFromAssignments();
		}
	}
	/**
...
//			System.out.println("delay " + new java.util.Date(getStart()) + new java.util.Date(getTaskStart()));
	...
	void setContour(Object type, AbstractContourBucket[] buckets) {
		if (type == TimeDistributedConstants.WORK) {
			workContour  = PersonalContour.getInstance(buckets);
		} else if (type == TimeDistributedConstants.COST) {
...
//	}
	...
	public WorkCalendar getEffectiveWorkCalendar() {
		...
		if (task.isIgnoreResourceCalendar() || isInvalidIntersectionCalendar() || resource.getEffectiveWorkCalendar() == null)
		{
...
//		return finish;
	...
	AbstractContourBucket[] getContour(Object type) {
		return ((type == TimeDistributedConstants.COST) ? costContour : workContour).getContourBuckets();
	}
	/**
