...
import com.projity.field.AlgorithmFieldUpdater;
...
public interface SchedulingAlgorithm
	extends ObjectEvent.Listener,
		HasSentinels,
		MultipleTransaction.Listener
{
	public void addObject( Object _task );

	public void addSubproject( Task _subproject );

	public void calculate( boolean _update );
	 ...
	 * @param project
	 */
	public void initialize( Object _object );

	@Override
	public void objectChanged( ObjectEvent _objectEvent );

	public void reset();

	public void setEarliestAndLatest( long _earliest, long _latest );
