 ...
 */
public class CriticalPathFields
	extends AlgorithmFieldUpdater
{
	/**
	 * Build list of fields that influence the critical path
	 */
	private CriticalPathFields( 
		Object _eventSource,
		Document _document )
	{
		super( _eventSource, _document );

		if (myStaticInputFields == null)
		{
			init();
			myStaticInputFields = myInputFields;
			myStaticOutputFields = myOutputFields;
		}

		myInputFields = myStaticInputFields;
		myOutputFields = myStaticOutputFields;
	}
	...
	static CriticalPathFields getInstance( 
		Object _eventSource,
		Document _document )
	{
		return new CriticalPathFields( _eventSource, _document );
	}
...
// commented out for now - psc1952 2011.12.31		
//		addInputField( "Field.timesheetComplete" );
	...
	protected static HashSet<Field> myStaticInputFields = null;
	protected static HashSet<Field> myStaticOutputFields = null;
}
