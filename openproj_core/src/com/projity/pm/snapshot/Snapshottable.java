 ...
 * The snapshot data is indexed via an object. This permits easily moving to a non-integer-array based storage scheme in the 
 * future, such as having a hash table of named baselines.
 */
	...
	extends Cloneable
{
	 ...
	 * @param _snapshotId 
	 */
	void clearSnapshot( Object _snapshotId );
	 ...
	 * @return 
	 */
	DataSnapshot cloneSnapshot( DataSnapshot _snapshot );
	 ...
	 * @return 
	 */
	DataSnapshot getSnapshot( Object _snapshotId );
	
	/**
	 * 
	 * @param _snapshotId 
	 */
	void saveCurrentToSnapshot( Object _snapshotId );

	/**
	 * 
	 * @param _snapshot 
	 */
	void setCurrentSnapshot( DataSnapshot _snapshot );
	 ...
	 * @param _snapshot 
	 */
	void setSnapshot( Object _snapshotId, DataSnapshot _snapshot );
