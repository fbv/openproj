...
public class HasCommonKeyImpl
	extends HasUniqueIdImpl
	implements HasKey
{
	public HasCommonKeyImpl( 
		final DataObject _hasUniqueId,
		final long _uniqueId )
	{
		super(_hasUniqueId, _uniqueId);
	}
	...
	public HasCommonKeyImpl( 
		...
		final DataObject _hasUniqueId )
	{
		super(_local, _hasUniqueId);
	}

	//call init to complete initialization
	public static HasCommonKeyImpl deserialize( 
		final ObjectInputStream _s,
		final DataObject _hasUniqueId )
		throws IOException, ClassNotFoundException
	{
		long uniqueId = _s.readLong();
		HasCommonKeyImpl hasKey = new HasCommonKeyImpl(_hasUniqueId, uniqueId);
