...
public class ResourcePoolFactory
{
	...
	public static ResourcePool createResourcePool( 
		final String _name,
		final DataFactoryUndoController _undo )
	{
		final ResourcePool resourcePool = ResourcePool.createRourcePool( _name, _undo );
		getInstance().myResourcePools.add( resourcePool );
	...
	/**
	 * @return Returns the resource pools.
	 */
	...
	private ArrayList<ResourcePool> myResourcePools = new ArrayList<ResourcePool>();
