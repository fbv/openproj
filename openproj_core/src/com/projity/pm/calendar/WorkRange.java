...
public class WorkRange extends ImmutableInterval implements Cloneable,Serializable{ /* immutable */
	...
	boolean overlaps(WorkRange other) {
		if (other == null)
			return false;
		if ( (myStart > other.myStart && myEnd > other.myEnd) ||
			 (other.myStart > myStart && other.myEnd > myEnd))
			 return false;
		return true;
	}
	...
	boolean isBefore(WorkRange other) {
		if (other == null)
			return true;
		return  (myStart < other.myStart && myEnd < other.myEnd); // change done here was > before
	}
	...
	public String toString() {
		...
		cal.setTimeInMillis( myStart );
		GregorianCalendar cal2 = DateTime.calendarInstance();;
		cal2.setTimeInMillis( myEnd );
...
//		cal.roll(GregorianCalendar.HOUR_OF_DAY,false);
	...
	public Date getNormalizedStartTime() {
		return getNormalized( myStart );
	}
	public Date getNormalizedEndTime() {
		return getNormalized( myEnd );
	}
