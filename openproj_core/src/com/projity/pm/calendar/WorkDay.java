...
public class WorkDay
	...
	implements Comparable<WorkDay>,
		...
		Serializable
{
	/** Constructor for WorkDay
	 * 
	 * @param _fromDate used to initialize the from attribute
	 * @param _toDate used to initialize the to attribute
	 */
	public WorkDay( 
		final long _fromDate,
		final long _toDate )
	{
		super( _fromDate, _toDate );
	}
	...
	{
		super( _fromDate, _toDate, _description );
	}
...
//	}
	...
	public int compareTo( 
		final WorkDay _other )
	{
//		if (_other instanceof WorkDay) // if comparing to a date
//		{
			return MathUtils.signum( (getStart() - _other.getStart()) );
//		}
//
//		if (_other instanceof Date) // if comparing to a date
//		{
//			return MathUtils.signum( getStart() - ((Date)_other).getTime() );
//		}
//
//		if (_other instanceof Calendar) // if comparing to a date
//		{
//			return MathUtils.signum( getStart() - ((Calendar)_other).getTimeInMillis() );
//		}
//
//		throw new ClassCastException("Cant compare" + _other + " to a WorkDay");
	}

	public static WorkDay deserialiseCompact( 
		ObjectInputStream s )
	...
	public boolean equals( 
		Object _other )
	{
		if (_other instanceof WorkDay == false)
		{
			return false;
		}

		return (getStart() == ((WorkDay)_other).getStart());
	}
	...
	public boolean hasSameWorkHours( 
		WorkDay d )
	{
	...
	public void serialiseCompact( 
		...
		throws IOException
	{
		_stream.writeLong( myStart );
		_stream.writeLong( myEnd );
		_stream.writeObject( myDescription );
	}
	...
	{
		return "work day " + new Date(myStart) + " " + hashCode() + "\n" + workingHours.toString() + "\n";
	}
