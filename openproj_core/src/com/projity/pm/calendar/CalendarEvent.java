	...
	implements Serializable
{
	...
	public CalendarEvent( 
		...
		long _end )
	{
		this( _start, _end, DEFAULT_DESCRIPTION );
	}
	...
	public CalendarEvent( 
		...
		String _description )
	{
		this( _date, _date, _description );
	}

	public CalendarEvent( 
		long _date )
	{
		this( _date, DEFAULT_DESCRIPTION );
	}
...
//		HasStartAndEnd _2 )
//	{
//		if (!(_1 instanceof CalendarEvent) || !(_2 instanceof CalendarEvent))
//		{
//			return 0;
//		}
//
//		return super.compare( _1, _2 );
//	}
	...
	public boolean equals( 
		final Object _other )
	{
		if (_other instanceof CalendarEvent == false)
		{
			return false;
		}
		...
		return myDescription.equals( ((CalendarEvent)_other).myDescription );
	}
