...
public class DependencyType
{
	...
	public static Integer mapStringToValue( 
		String textValue )
	{
	...
	public static String mapValueToString( 
		Integer value )
	{
	 ...
	 */
	private static String typePatternString = "(" // group1
		 +"\\s*" // optional whitespace before 
		 +"(" // group2 
		 +Messages.getString( "DependencyType.SS" ) + "|" + Messages.getString( "DependencyType.SF" ) + "|" +
		Messages.getString( "DependencyType.FS" ) + "|" + Messages.getString( "DependencyType.FF" ) + "|" +
		Messages.getString( "DependencyType.SS" ).toLowerCase() + "|" + Messages.getString( "DependencyType.SF" ).toLowerCase() +
		"|" + Messages.getString( "DependencyType.FS" ).toLowerCase() + "|" +
		Messages.getString( "DependencyType.FF" ).toLowerCase() + ")?" // End group 2: SS,SF,FS,FF or nothing
