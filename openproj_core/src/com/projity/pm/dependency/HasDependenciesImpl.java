		...
		Serializable
{
	 ...
	 */
	public Closure forAllPredecessors( 
		Closure visitor )
	{
	...
	public Closure forAllSuccesssors( 
		Closure visitor )
	{
		return new CollectionVisitor(visitor)
			{
	...
	/* (non-Javadoc)
	 * @see com.projity.pm.dependency.HasDependencies#getList(boolean)
	 */
	...
	/**
	 * @return Returns the hasCalendar.
	 */
