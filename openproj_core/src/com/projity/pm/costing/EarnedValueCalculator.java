...
public class EarnedValueCalculator
{
	...
	public ImageLink getBudgetStatusIndicator( 
		double cpi )
	{
		return ImageLink.trafficLight( (cpi == 0.0D)
			? NO_BASELINE
			: (Messages.getString( "EarnedValueCalculator.CPI" ) + "=" + cpi), cpi, 1.0D, 0.9D ); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public ImageLink getScheduleStatusIndicator( 
		double spi )
	{
		return ImageLink.trafficLight( (spi == 0.0D)
			? NO_BASELINE
			: (Messages.getString( "EarnedValueCalculator.SPI" ) + "=" + spi), spi, 1.0D, 0.9D ); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public ImageLink getStatusIndicator( 
		double csi )
	{
		return ImageLink.trafficLight( (csi == 0.0D)
			? NO_BASELINE
			: (Messages.getString( "EarnedValueCalculator.CSI" ) + "=" + csi), csi, 1.0D, 0.81D ); //$NON-NLS-1$ //$NON-NLS-2$
	}
