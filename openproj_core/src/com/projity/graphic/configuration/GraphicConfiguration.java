...
public class GraphicConfiguration {
	...
	public static GraphicConfiguration getInstance(){
		return Configuration.getInstance().getGraphicConfiguration();
	}
	...
	public static void addDigesterEvents(Digester digester){
		...
		digester.addSetNext("*/graphic", "setGraphicConfiguration", "com.projity.graphic.configuration.GraphicConfiguration");
