		...
		DoubleValue
{
	private WeightedSum( 
		...
		final CollectionIntervalGenerator _generator )
	{
		super();
		myWorkCalendar = _cal;
	...
	{
		final double currentVal = ((DoubleValue)myGenerator.current()).getValue();
		myValue += (myWorkCalendar.compare( _interval.getEnd(), _interval.getStart(), false ) * currentVal);
	}
	...
	public static WeightedSum getInstance( 
		...
		final CollectionIntervalGenerator _generator )
	{
		return new WeightedSum( _cal, _generator );
	}
	...
	private final CollectionIntervalGenerator myGenerator;
