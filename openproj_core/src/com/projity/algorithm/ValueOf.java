...
public class ValueOf
	implements CalculationVisitor<Object>,
		DoubleValue
{
	/**
	 *
	...
	public void execute( 
		Object _arg0 )
	{
		myValue = myFirst.getValue();
		System.out.println( "valueOf" + myValue );
	}
	 ...
	 * @return
	 */
	public static ValueOf getInstance( 
		DoubleValue _first )
	{
		return new ValueOf( _first );
	}
