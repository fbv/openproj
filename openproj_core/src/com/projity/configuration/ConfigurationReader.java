...
{
	public static ProvidesDigesterEvents read( 
		String configurationUrl,
		ProvidesDigesterEvents root )
	{
		URL url = ConfigurationReader.class.getClassLoader().getResource( configurationUrl );

		if (url == null)
		{
			log.severe( "could not find xml configuration file: " + configurationUrl );
		...
		{
			log.severe( "Could not read field xml configuration file " + url );
			e.printStackTrace();
		}
	...
	public static ProvidesDigesterEvents readStream( 
		InputStream stream,
		ProvidesDigesterEvents root )
	{
		ProvidesDigesterEvents result = null;
		...
		{
			log.severe( "Could not read field xml configuration file: " + e1 );
...
//			e1.printStackTrace();
		...
		{
			log.severe( "Error parsing field xml configuration file: " + e1 );
...
//			e1.printStackTrace();
		...
		{
			log.severe( "Unknown exception: " + _e );
	...
	public static ProvidesDigesterEvents readString( 
		String str,
		ProvidesDigesterEvents root )
	{
		if (str == null)
