...
//		myClassLoader = _classLoader;
	...
	{
		System.out.println( "loadClass " + _name );
		return super.loadClass( _name );
//		return myClassLoader.loadClass( _name );
	}
	...
	protected Class findClass(
		...
		throws ClassNotFoundException 
	{
		System.out.println( "findClass " + _name );
	...
	{
		System.out.println( "findLibrary " + _libname );
		return super.findLibrary( _libname );
	}
	...
	protected URL findResource(
		final String _name ) 
	{
		System.out.println( "findResource " + _name );
