...
public class Environment
{
	...
	public static int compareJavaVersion( 
		String version1,
		String version2 )
	{
	...
	*/
	public static int compareJavaVersionTo( 
		String version )
	{
	...
	public static final void setBatchMode( 
		boolean processingUndoRedo )
	{
		Environment.batchMode = processingUndoRedo;
	}

	public static final void setClientSide( 
		boolean clientSide )
	{
	...
	public static void setImportTesting( 
		boolean importTesting )
	{
	...
	public static void setKeepExternalLinks( 
		boolean keepExternalLinks )
	{
		Environment.keepExternalLinks = keepExternalLinks;
	}

	public static void setNeedToRestart( 
		boolean needToRestart )
	{
		Environment.needToRestart = needToRestart;
	}

	public static void setNewLaf( 
		boolean newLaf )
	{
		Environment.newLaf = newLaf;
	}

	public static void setNewLook( 
		boolean newLook )
	{
	...
	public static void setNoPodServer( 
		boolean noPodServer )
	{
	...
	public static final void setPartnerId( 
		String partnerId )
	{
	...
	public static void setProxyAuth( 
		String proxyAuth )
	{
		Environment.proxyAuth = proxyAuth;
	}

	public static void setScripting( 
		boolean scripting )
	{
		Environment.scripting = scripting;
	}

	public static final void setStandAlone( 
		boolean standAlone )
	{
	...
	public static boolean setUpdatingTimesheet( 
		boolean updatingTimesheet )
	{
		return Environment.updatingTimesheet = updatingTimesheet;
	}

	public static final void setUser( 
