...
public class EditOption
{
	...
	public EditOption()
	{
		...
		GlobalPreferences.getInstance().addObjectListener( 
			new ObjectEvent.Listener()
		{
			@Override
		...
		final int _index )
	{
		...
		return viewAs[ _index % (viewAs.length) ];
	}
	 ...
	 */
	public void setAddSpaceBeforeLabel( 
		final boolean _addSpaceBeforeLabel )
	{
		this.addSpaceBeforeLabel = _addSpaceBeforeLabel;
	}
	...
	{
		this.shortDateFormat = _shortDateFormat;
	}

	public void setViewAs( 
		final int _index,
		final int _value )
	{
		viewAs[ _index % (viewAs.length) ] = _value;
	}

	private static EditOption instance = null;
	private DateFormat shortDateFormat = null;
	private DateFormat dateFormat = null;
	private int[] viewAs = new int[]
	{
		2,
		2,
		2,
		...
		2,
		2
	}; // index into resource string of types array.  See DurationFormat
