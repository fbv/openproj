...
public abstract class ResourceMappingForm
{
	...
	public void selectMergeField( 
		MergeField mergeField )
	{
	}

	public void setAccessControlType( 
		int accessControlType )
	{
		this.accessControlType = accessControlType;
	}

	public void setExistingProject( 
		Project existingProject )
	{
		this.existingProject = existingProject;
	}

	public void setImportedResources( 
		List importedResources )
	{
		this.importedResources = importedResources;
	}

	public void setJunit( 
		boolean junit )
	{
		this.junit = junit;
	}
		...
		if (mergeField != NO_MERGE)
		{
			for (Iterator i = resources.iterator(); i.hasNext();)
			{
				...
				try
				{
					...
					if (mergeFieldMap.containsKey( value ))
					{ //not duplicates
	...
	public void setSelectedResources( 
		List selectedResources )
	{
		this.selectedResources = selectedResources;
	}

	public void setUnassignedResource( 
		Object projityUnassignedResource )
	{
