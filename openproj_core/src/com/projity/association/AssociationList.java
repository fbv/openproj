	...
	implements List
{
	...
	public static List extractDistinct( 
		List list,
		boolean leftObject )
	{
	...
	public static Association findAssociation( 
		LinkedList findInList,
		Object left,
		Object right,
		Association exclude )
	{
	...
	public Association findLeft( 
		Object left )
	{
		return find( true, left );
	}

	public Association findRight( 
		Object right )
	{
	...
	public AssociationList setAssociations( 
		String associations,
