...
{
	private AssociationFormatParameters( 
		HasDependencies thisObject,
		boolean leftAssociation,
		com.projity.field.Field idField,
		boolean encloseInBrackets,
		boolean allowDetailsEntry )
	{
	 ...
	 */
	public com.projity.field.Field getIdField()
	{
		return idField;
	}

	public static AssociationFormatParameters getInstance( 
		HasDependencies thisObject,
		boolean leftAssociation,
		com.projity.field.Field idField,
		boolean encloseInBrackets,
