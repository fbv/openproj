...
//	}
	...
	{
		if (getType() == DataObjectConstants.COMPANY_TYPE)
		{
			return "Company";
		}
		else if (getType() == DataObjectConstants.CALENDAR_TYPE)
		{
			return "Calendar";
		}
		else if (getType() == DataObjectConstants.PROJECT_TYPE)
		{
			return "Project";
		}
		else if (getType() == DataObjectConstants.ENTERPRISE_RESOURCE_TYPE)
		{
			return "EnterpriseResource";
		}
		else if (getType() == DataObjectConstants.RESOURCE_TYPE)
		{
			return "Resource";
		}
		else if (getType() == DataObjectConstants.TASK_TYPE)
		{
			return "Task";
		}
		else if (getType() == DataObjectConstants.ASSIGNMENT_TYPE)
		{
			return "Assignment";
		}
		else if (getType() == DataObjectConstants.LINK_TYPE)
		{
			return "Link";
		}
		else if (getType() == DataObjectConstants.BANKING_INFO_TYPE)
		{
			return "BankingInfo";
		}
		else if (getType() == DataObjectConstants.CREDIT_CARD_BANKING_INFO_TYPE)
		{
			return "CreditCardBankingInfo";
		}
		else if (getType() == DataObjectConstants.CHECK_BANKING_INFO_TYPE)
		{
			return "CheckBankingInfo";
		}
		else if (getType() == DataObjectConstants.USER_TYPE)
		{
			return "User";
		}
		else if (getType() == DataObjectConstants.PARTNER_USER_TYPE)
		{
			return "PartnerUser";
		}
		else if (getType() == DataObjectConstants.PARTNER_COMPANY_TYPE)
		{
	...
	{ // will be true for external tasks
		...
		throws UniqueIdException
	{
		if (isLocal( data ))
		{
			data.setUniqueId( SessionFactory.getInstance().getSession( false ).getId() );
		}
	}
