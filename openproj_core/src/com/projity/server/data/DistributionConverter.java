...
public class DistributionConverter
{
	...
	public List createDistributionData( 
		Project project,
		boolean incremental )
	{
		if (delegate != null)
		{
			try
			{
				return (List)delegateClass.getMethod( "createDistributionData", new Class[]
					{
						Project.class,
						boolean.class
	...
	public void substractDistributionFromProject( 
		Project project )
	{
		if (delegate != null)
		{
			try
			{
				delegateClass.getMethod( "substractDistributionFromProject", new Class[]
					{
						Project.class
					} ).invoke( delegate, new Object[]
					{
