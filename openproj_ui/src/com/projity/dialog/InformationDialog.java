	...
	extends FieldDialog
{
	...
	protected abstract JComponent createHeaderFieldsPanel( FieldComponentMap _map );
			...
			assignResourceButton.addActionListener( new ActionListener()
				...
				@Override
						...
						ActionEvent arg0 )
					{
						...
						GraphicManager.getInstance( assignResourceButton ).getMenuManager()
									  .getActionFromId( MenuActionConstants.ACTION_ASSIGN_RESOURCES ).actionPerformed( arg0 );
					}
				} );
		}
		...
		if (changeWorkingTimeButton == null)
		{
			...
			changeWorkingTimeButton.addActionListener( new ActionListener()
				...
				@Override
					...
					{
						//route message to main frame
						GraphicManager.getInstance( changeWorkingTimeButton ).getMenuManager()
									  .getActionFromId( MenuActionConstants.ACTION_CHANGE_WORKING_TIME ).actionPerformed( arg0 );
					}
				} );
		}
	...
	protected JComponent pairedComponents( 
