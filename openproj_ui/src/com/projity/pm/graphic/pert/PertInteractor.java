...
public class PertInteractor extends NetworkInteractor {
    ...
    protected boolean switchOnLinkCreation(double x, double y){
		...
		return (node.getNode().getValue() instanceof HasDependencies&&!shape.contains(x,y));
    }
		...
		case LINK_CREATION:
			try {
					if (sourceNode!=null&&destinationNode!=null&&
						...
						DependencyService.getInstance().newDependency((HasDependencies)sourceNode.getNode().getValue(),(HasDependencies)destinationNode.getNode().getValue(),DependencyType.FS,0,this);
					}
