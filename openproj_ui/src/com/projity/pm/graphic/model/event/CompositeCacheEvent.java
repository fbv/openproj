	...
	extends EventObject
{
	 ...
	 * @param edgeEvents
	 */
	public CompositeCacheEvent( 
		final Object _source,
		final List _nodeEvents,
		final List _edgeEvents )
	{
		super(_source);
		this.nodeEvents = _nodeEvents;
		this.edgeEvents = _edgeEvents;
	}
	...
	public void setEdgeEvents( 
		final List _edgeEvents )
	{
		this.edgeEvents = _edgeEvents;
	}

	public void setNodeEvents( 
		final List _nodeEvents )
	{
		this.nodeEvents = _nodeEvents;
	}
