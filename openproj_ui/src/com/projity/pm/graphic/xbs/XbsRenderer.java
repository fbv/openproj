...
public final class XbsRenderer
	extends NetworkRenderer
{
	...
	@Override
	public final Iterator<GraphicDependency> getDependenciesIterator()
	{
		//TODO correct for svg
		return ((XbsLayout)((NetworkParams)graphInfo).getNetworkLayout()).getDependencies().iterator();
	}

	@Override
	protected final Point2D getNonScaledCenter( 
		final GraphicNode _node )
	{
		return _node.getXbsCenter();
	}

	@Override
	protected final GeneralPath getNonScaledShape( 
		final GraphicNode _node )
	{
		return _node.getXbsShape();
	}

	@Override
	protected final void translateNonScaledShape( 
		final GraphicNode _node,
		final double _dx,
		final double _dy )
	{
		_node.translateXbsShape( _dx, _dy );
	}
}
