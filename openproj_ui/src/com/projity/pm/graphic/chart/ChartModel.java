...
public class ChartModel implements Serializable {
	...
	public CalculatedValues computeTrace(Iterator taskIterator, List resources, TimeDistributedConstants trace,  boolean histogram, boolean cumulative) {
...
//	}
	...
	public void computeHistogram(Project project, List tasks, List resources,Object[] traces) {
		...
		//This Project
		GroupedCalculatedValues thisProjectCalculatedValues = (GroupedCalculatedValues) computeTrace(project.getTaskOutlineIterator(), 
			resources, TimeDistributedConstants.WORK,  true, false);

		//Selected
		GroupedCalculatedValues selectedCalculatedValues = (GroupedCalculatedValues) computeTrace(tasks==null?null:tasks.iterator(),
			resources, TimeDistributedConstants.WORK,  true, false);
		...
		XYSeries availabilitySeries = buildHistogramSeries(TimeDistributedConstants.AVAILABILITY,availabilityCalculatedValues);
		XYSeries otherProjectsSeries = null;
		if (otherProjectsCalculatedValues!=null) otherProjectsSeries=buildHistogramSeries(TimeDistributedConstants.OTHER_PROJECTS,otherProjectsCalculatedValues);
		XYSeries thisProjectSeries = buildHistogramSeries(TimeDistributedConstants.THIS_PROJECT,thisProjectCalculatedValues);
		XYSeries selectedSeries = buildHistogramSeries(TimeDistributedConstants.SELECTED,selectedCalculatedValues);
	...
	private boolean isTraceRectilinear(Object trace) {
		return trace == TimeDistributedConstants.AVAILABILITY;
	}
	...
	public void computeValues(List tasks, List resources, boolean cumulative, TimeDistributedConstants[] traces, boolean histogram) {
		if (tasks == null)
			return;
	...
	private boolean isTaskBased(Object trace) {
		return (trace == TimeDistributedConstants.FIXED_COST ||
				trace == TimeDistributedConstants.ACTUAL_FIXED_COST);
	}
