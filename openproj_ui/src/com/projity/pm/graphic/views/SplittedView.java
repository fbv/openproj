	...
	extends JSplitPane
{
	...
	public void init()
	{
		...
		if (sync)
		{
			synchronizer.addSynchro( leftScrollPane, rightScrollPane, ScrollPaneSynchronizer.HORIZONTAL );
		}
	 ...
	 */
	public void setDeltaDivider( 
		int deltaDivider )
	{
		this.deltaDivider = deltaDivider;
	}

	public void setDividerLocationSilent( 
		int location )
	{
