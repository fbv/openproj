	...
	protected JScrollPane createLeftScrollPane() {
		spreadSheet = new SpreadSheet() {
			...
			public boolean isNodeDeletable(Node node) {
				return !(node.getValue() instanceof Resource); // only delete resource on res list
			}};
...
//		timeSpreadSheet.repaint();
	...
	public void restoreWorkspace(WorkspaceSetting w, int context) {
		...
		timeSpreadSheet.setSelectedFieldArray((ArrayList) Configuration.fromIdArray(ws.selectedFieldArray));
	...
	public WorkspaceSetting createWorkspace(int context) {
		...
		ws.selectedFieldArray = Configuration.toIdArray(timeSpreadSheet.getSelectedFieldArray());
