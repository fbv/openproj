...
public class ScrollPaneSynchronizer
{
	...
	public void activateSynchro()
	{
		if (listener == null)
		{
			...
			else if (orientation == VERTICAL)
			{
				...
				scrollPane1.setHorizontalScrollBarPolicy( JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS );
				scrollPane2.setHorizontalScrollBarPolicy( (bottomBarActivated)
	 ...
	 */
	public void setBottomBarActivated( 
		boolean bottomBarActivated )
	{
	 ...
	 */
	public void setBottomBarEnabled( 
