		...
		Cloneable
{
	...
	public GraphParams createSafePrintCopy()
	{
		...
		if (c.printBounds != null)
		{
			c.printBounds = (Rectangle)c.printBounds.clone();
		}
	...
	{
		return new Rectangle(0, configuration.getColumnHeaderHeight(), (int)Math.ceil( coord.getWidth() ),
			getRowHeight() * cache.getSize());
	...
	public void setColumnHeaderFont( 
